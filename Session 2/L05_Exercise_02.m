...
hToolFig = imtool(original_BP);
set(hToolFig, 'Name', 'Reconstructed Image');
...
hToolFig = imtool(original_BP);
set(hToolFig, 'Name', 'Reconstructed User Image (Hamming Filter)');
...
hToolFig = imtool(original_BP);
set(hToolFig, 'Name', 'Reconstructed User Image (Cosine Filter)');
